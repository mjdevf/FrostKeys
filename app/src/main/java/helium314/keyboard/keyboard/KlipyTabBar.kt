...
fun KlipyTabBar(
    ...
    val colorScheme = remember(isNight, primaryVal, onPrimaryVal, surfaceVal, onSurfaceVal) {
        if (isNight) darkColorScheme(
            primary = primaryVal, onPrimary = onPrimaryVal,
            surface = surfaceVal, onSurface = onSurfaceVal,
            secondaryContainer = surfaceVal, onSecondaryContainer = onSurfaceVal,
            surfaceVariant = surfaceVal, onSurfaceVariant = onSurfaceVal,
            outline = Color.Transparent, outlineVariant = Color.Transparent
                        ...
                        buttonGroupContent = {
                            ...
                            ToggleButton(
                                ...
                                onCheckedChange = { checked ->
                                    if (checked) onTabSelected(tabType)
                                },
                                shapes = buttonShapes,
